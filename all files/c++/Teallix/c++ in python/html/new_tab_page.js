...
class PageMetricsHostRemote {
    ...
    onPageRemoteCreated(page) {
        this.proxy.sendMessage(410065907, PageMetricsHost_OnPageRemoteCreated_ParamsSpec.$, null, [page])
    }
    onGetMark(name) {
        return this.proxy.sendMessage(748620572, PageMetricsHost_OnGetMark_ParamsSpec.$, PageMetricsHost_OnGetMark_ResponseParamsSpec.$, [name])
    }
    onClearMark(name) {
        this.proxy.sendMessage(1121591101, PageMetricsHost_OnClearMark_ParamsSpec.$, null, [name])
    }
    onUmaReportTime(name, time) {
        this.proxy.sendMessage(1955133236, PageMetricsHost_OnUmaReportTime_ParamsSpec.$, null, [name, time])
    }
}
...
class PageMetricsRemote {
    ...
    onGetMark(name) {
        return this.proxy.sendMessage(543982696, PageMetrics_OnGetMark_ParamsSpec.$, PageMetrics_OnGetMark_ResponseParamsSpec.$, [name])
    }
    onClearMark(name) {
        this.proxy.sendMessage(1171350179, PageMetrics_OnClearMark_ParamsSpec.$, null, [name])
    }
}
class PageMetricsCallbackRouter {
    constructor() {
        ...
        this.helper_internal_.registerHandler(543982696, PageMetrics_OnGetMark_ParamsSpec.$, PageMetrics_OnGetMark_ResponseParamsSpec.$, this.onGetMark.createReceiverHandler(true));
        this.onClearMark = new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(1171350179, PageMetrics_OnClearMark_ParamsSpec.$, null, this.onClearMark.createReceiverHandler(false));
...
<cr-dialog id="dialog" show-on-attach>
  ...
  <div slot="body">
    ...
    <cr-input readonly="readonly" label="Doodle Link" id="url" value="[[url.url]]">
...
class HelpBubbleHandlerFactoryRemote {
    ...
    createHelpBubbleHandler(client, handler) {
        this.proxy.sendMessage(2038476842, HelpBubbleHandlerFactory_CreateHelpBubbleHandler_ParamsSpec.$, null, [client, handler])
    }
}
...
class HelpBubbleHandlerRemote {
    ...
    helpBubbleAnchorVisibilityChanged(nativeIdentifier, visible, rect) {
        this.proxy.sendMessage(1895186421, HelpBubbleHandler_HelpBubbleAnchorVisibilityChanged_ParamsSpec.$, null, [nativeIdentifier, visible, rect])
    }
    helpBubbleAnchorActivated(nativeIdentifier) {
        this.proxy.sendMessage(1761864081, HelpBubbleHandler_HelpBubbleAnchorActivated_ParamsSpec.$, null, [nativeIdentifier])
    }
    helpBubbleAnchorCustomEvent(nativeIdentifier, customEventName) {
        this.proxy.sendMessage(43714761, HelpBubbleHandler_HelpBubbleAnchorCustomEvent_ParamsSpec.$, null, [nativeIdentifier, customEventName])
    }
    helpBubbleButtonPressed(nativeIdentifier, buttonIndex) {
        this.proxy.sendMessage(791052551, HelpBubbleHandler_HelpBubbleButtonPressed_ParamsSpec.$, null, [nativeIdentifier, buttonIndex])
    }
    helpBubbleClosed(nativeIdentifier, reason) {
        this.proxy.sendMessage(820808931, HelpBubbleHandler_HelpBubbleClosed_ParamsSpec.$, null, [nativeIdentifier, reason])
    }
}
...
class HelpBubbleClientRemote {
    ...
    showHelpBubble(params) {
        this.proxy.sendMessage(1329025669, HelpBubbleClient_ShowHelpBubble_ParamsSpec.$, null, [params])
    }
    toggleFocusForAccessibility(nativeIdentifier) {
        this.proxy.sendMessage(1409395153, HelpBubbleClient_ToggleFocusForAccessibility_ParamsSpec.$, null, [nativeIdentifier])
    }
    hideHelpBubble(nativeIdentifier) {
        this.proxy.sendMessage(1430978883, HelpBubbleClient_HideHelpBubble_ParamsSpec.$, null, [nativeIdentifier])
    }
    externalHelpBubbleUpdated(nativeIdentifier, shown) {
        this.proxy.sendMessage(166450109, HelpBubbleClient_ExternalHelpBubbleUpdated_ParamsSpec.$, null, [nativeIdentifier, shown])
    }
}
class HelpBubbleClientCallbackRouter {
    constructor() {
        ...
        this.helper_internal_.registerHandler(1329025669, HelpBubbleClient_ShowHelpBubble_ParamsSpec.$, null, this.showHelpBubble.createReceiverHandler(false));
        this.toggleFocusForAccessibility = new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(1409395153, HelpBubbleClient_ToggleFocusForAccessibility_ParamsSpec.$, null, this.toggleFocusForAccessibility.createReceiverHandler(false));
        this.hideHelpBubble = new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(1430978883, HelpBubbleClient_HideHelpBubble_ParamsSpec.$, null, this.hideHelpBubble.createReceiverHandler(false));
        this.externalHelpBubbleUpdated = new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(166450109, HelpBubbleClient_ExternalHelpBubbleUpdated_ParamsSpec.$, null, this.externalHelpBubbleUpdated.createReceiverHandler(false));
        this.onConnectionError = this.helper_internal_.getConnectionErrorEventRouter()
    }
    removeListener(id) {
        return this.router_.removeListener(id)
...
<div id="content" style="--color-new-tab-page-attribution-foreground:[[rgbaOrInherit_(theme_.textColor) ]];--color-new-tab-page-most-visited-foreground:[[rgbaOrInherit_(theme_.textColor) ]];--ntp-logo-color:[[rgbaOrInherit_(logoColor_) ]]">
  <template is="dom-if" if="[[lazyRender_]]">
    <template is="dom-if" if="[[oneGoogleBarEnabled_]]">
      <div id="oneGoogleBarScrim" hidden$="[[!showOneGoogleBarScrim_]]" fixed$="[[scrolledToTop_]]"></div>
  ...
  <dom-if if="[[lazyRender_]]" on-dom-change="onLazyRendered_">
    <template>
      ...
      <template is="dom-if" if="[[modulesEnabled_]]">
        ...
        <template is="dom-if" if="[[modulesRedesignedEnabled_]]">
          <ntp-modules-v2 id="modules" on-customize-module="onCustomizeModule_" on-modules-loaded="onModulesLoaded_" hidden="[[!promoAndModulesLoaded_]]">
          </ntp-modules-v2>
        </template>
      </template>
      ...
      <div id="customizeButtonContainer">
        <cr-button id="customizeButton" on-click="onCustomizeClick_" title="Customize this page" aria-pressed="[[showCustomize_]]">
    ...
    static get properties() {
        return {
            ...
            showOneGoogleBarScrim_: {
                type: Boolean,
                computed: "computeShowOneGoogleBarScrim_(removeScrim_, showBackgroundImage_)"
            },
