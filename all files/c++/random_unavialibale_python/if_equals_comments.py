...
while True: # Creates a loop for the user
    ...
    if ai == "yes": # If they say yes it defines a new line
        def generator(): # Defines a new line for two random numbers between 1 and 9 to add each other
            num1 = random.randint(1,2) # Defines that num1 is equal to a random number between 1 and 9
            num2 = random.randint(1,3) # Defines that num2 is equal to a random number between 1 and 9
            
            print(num1, "+", num2, "=", random.randint(1,9))# Prints two random numbers plus each other
